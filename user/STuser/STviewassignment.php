...
if (isset($_POST["submit"])) {
	$str = $_POST["search"];
	$sth = $con->prepare("SELECT * FROM `stassignment` WHERE SubjecID = '$str'");
...
<head>
    ...
    <title>ST View Assignment page</title>
   ...
   <div class="col-sm-8">
    ...
    <div class="table-responsive">
      ...
      <tr>
                ...
                <label><?php echo $row->login; ?></label><br><br>
                <label class="S-lable">SubjecID:</label> 
                <label><?php echo $row->SubjecID; ?></label><br>
                ...
                <label class="S-lable" class="S-lable">Sday:</label> 
                <label><?php echo $row->Sday; ?></label><br>
				 
                
                

                <label class="S-lable">View:</label>
               
      <a href="downloads.php?file_id=$res['id']"><?php echo $row->name; ?></a>     
