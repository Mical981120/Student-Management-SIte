<?php 
	  ...
	  $result = mysqli_query($mysqli, "SELECT * FROM pcpayment WHERE id=$id");
...
<body>
   ...
   <main>
     ...
     <section class="glassmiddle">
        ...
        font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; ">Pay</h1>
			</center>
			<form name='myform' action="function.php" onsubmit="return validate()" method="post" enctype="multipart/form-data">
            <?php include('error.php'); ?>
            <input type="hidden" name="id" value=<?php echo $_GET['id'];?>><br>
            <input type="hidden" name="Status" value="Payed"><br>
                <label>Month id:</label>   
                <input type="textfield" name="Mid" value="<?php echo $MID;?>"><br>
				<label>Amount:</label>   
                <input type="textfield" name="Amount" value="<?php echo $Amount;?>"><br>
                
                
                
                <label>Last Date:</label>   
                <input type="Date" name="Pday" value="<?php echo $Ldate;?>"><br>
                <label>Month:</label>   
                
                <input type="textfield" name="Month" value="<?php echo $Month;?>"><br>
                   
                <label>User ID:</label>   
                <input type="textfield" name="login" required autofocus><br>
				...
				<button type="submit" class="Addbtn" value="submit" name="payR">Pay</button>
