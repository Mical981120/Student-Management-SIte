...
if (isset($_POST["submit"])) {
	$str = $_POST["search"];
	$sth = $con->prepare("SELECT * FROM `result` WHERE StudentI = '$str'");
    ...
    header("Location: STresult.php?error=Invalid Index Numnber!");
  }
...
<body>
   ...
   <main>
     ...
     <section class="glassmiddle">
        ...
        font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; ">View Result</h1>
			</center>
			<div class="container">
 <div class="row">
   <div class="col-sm-8">
    ...
    <div class="table-responsive">
      ...
      <tr>
                ...
                <input type="text" name="search" placeholder="Index Number.." required autofocus>
                <button type="submit" name="submit" class=>Submit</button>
                <?php if (isset($_GET['error'])) { ?>
     	<center><p class="error"><?php echo $_GET['error']; ?></p></center>	
     	<?php } ?>
                </div><br>  
                <center><h2 style="font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; color: darkblue; ">Result</h2></center>
                <hr><br>
                ...
                <label class="S-lable">Semester:</label>  
                <label ><?php echo $row->Semester; ?></label><br>

                <label class="S-lable">Subject:</label>  
                <label ><?php echo $row->Subject; ?></label><br>
                <label class="S-lable" class="S-lable">Result:</label> 
                <label><?php echo $row->Result; ?></label><br>
				        <label class="S-lable">Grade:</label>
                <label ><?php echo $row->Grade; ?></label><br> 
                <label class="S-lable">Feedback:</label>
                <label ><?php echo $row->Feedback; ?></label><br> 
