...
$result = mysqli_query($mysqli, "SELECT * FROM paymentrecords ORDER BY MID DESC");
?>
...
<head>
    ...
    <title>ST Payment Recordes page</title>
   ...
   <main style="display: flex;">
     ...
     <div class="container" style="width: 900px;, align-items: center;,
      ...
      <center>
        ...
        font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; ">Payment Records</h1>
			</center>
...
<?php 
	...
	while($res = mysqli_fetch_array($result)) { 		
		...
		echo "<td><a class='printbtn' href='Invoice.php?id=$res[id]'>Print</a>";  
