...
<head>
    ...
    <title>MS ST Register page required</title>
...
<body>
   ...
   <main>
     ...
     <section class="glassmiddle">
        ...
        font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; ">Add New Student</h1>
			</center>
            ...
            <?php include('error.php'); ?>
                ...
                <input type="textfield" name="Ptime" required><br>
                <label>Join Date:</label>   
                <input type="Date" name="Jday" required><br>
                <label>Course:</label>   
                ...
                <br>
				<button type="submit" class="Addbtn" value="submit" name="addst">Create</button>
