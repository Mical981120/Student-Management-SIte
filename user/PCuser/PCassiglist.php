...
<head>
    ...
    <title>PC Assignment page</title>
   ...
   <main style="display: flex;">
     ...
     <div class="container" style="width: 700px;, align-items: center;,
      ...
      <center>
        ...
        font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; ">Assignment Table</h1>
			</center>
 
      <a href="PCaddAssignment.php"  class="functionketCT">Add New Assignment</a>
      <table>
<thead>
...
<?php 
	...
	while($res = mysqli_fetch_array($result)) { 		
		...
		echo "<td>".$res['Sday']."</td>";
        echo "<td><a class='downloadbtn' href='function.php?file_id=$res[id]'>Download</a>";
		echo "<td><a class='updatetbtn'href='PCupdateass.php?id=$res[id]'>Update</a>";  
		echo "<td><a class='deletebtn' href='delete-process5.php?id=$res[id]'>Delete</a>";
	}
	?>
</tbody>
</table>
