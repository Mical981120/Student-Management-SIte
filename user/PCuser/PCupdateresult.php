<?php 
	  ...
	  $result = mysqli_query($mysqli, "SELECT * FROM result WHERE id=$id");
...
<head>
    ...
    <title>PC Update Result required page</title>
...
<body>
   ...
   <main>
     ...
     <section class="glassmiddle">
        ...
        font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; ">Update Student Result</h1>
			</center>
			<form name='myform' action="update-process4.php"  method="post" >
            <?php include('error.php'); ?>
            <input type="hidden" name="id" value=<?php echo $_GET['id'];?>><br>
                <label>User ID:</label>
                <input type="textfield" name="login" required value="<?php echo $login;?>"><br>
				<label>User Name:</label>    
                <input type="textfield" name="Fname" required value="<?php echo $name;?>"><br>
                <label>Student Index:</label>    
                <input type="textfield" name="Sindex" required value="<?php echo $StudentI;?>"><br>
                ...
                <input type="Date" name="Rday" required value="<?php echo $Rday;?>"><br>
                ...
                <select name="Semester" class="Semester"  value="<?php echo $Semester;?>">
                    ...
                    <label>Result:</label>   
                <input type="textfield" name="Result" value="<?php echo $Result;?>"><br>
                <label>Grade:</label>   
                <select name="Grade" class="Grade"  value="<?php echo $Grade;?>">
                ...
                <input type="textfield" name="Feedback" value="<?php echo $Feedback;?>"><br>
