...
<head>
    ...
    <title>PC View ST Details page</title>
   ...
   <main>
     ...
     <section class="glassmiddle">
        ...
        font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; ">Add Student Details</h1>
			...
			<a href="PCstdetails.php"  class="functionketCT">Register New Student</a>
			<table>
	<thead>
	<th>Student Id</th>
	<th>Full Name</th>
	...
	while($res = mysqli_fetch_array($result)) { 		
		...
		echo "<td ><a class='updatetbtn' href='PCupdatestdetails.php?id=$res[id]'>Update</a>";  
		echo "<td><a class='deletebtn' href='delete-process1.php?id=$res[id]'>Delete</a>";         
	} 
	?>
	</tbody>
</table>
