...
<head>
    ...
    <title>PC Update User page</title>
     ...
     <section class="glassmiddle">
        ...
        font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; ">Update Student Details</h1>
			...
			<form name='myform' action="update-process1.php"  method="post">
                ...
                <input type="hidden" name="id" required  value=<?php echo $_GET['id'];?>><br>
				<label>Full Name:</label>    
                <input type="textfield" name="name" required value="<?php echo $name;?>"><br>
                <label>Address:</label>   
                <input type="textfield" name="Address" required  value="<?php echo $Address;?>"><br>
                <label>Mobile:</label>   
                <input type="textfield" name="Mobile" required  value="<?php echo $Mobile;?>"><br>
				
                <label>Email:</label>   
                <input type="Email" name="Email" required  value="<?php echo $Email;?>"><br>
                <label>Birth of Date:</label>   
                <input type="textfield" name="NIC" required  value="<?php echo $NIC;?>"><br>
                <label>First Name:</label>
                <input type="textfield" name="Fname" required  value="<?php echo $Fname;?>"><br>
