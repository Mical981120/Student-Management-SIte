...
$result = mysqli_query($mysqli, "SELECT * FROM result ORDER BY login DESC");
   ...
   <main style="display: flex;">
     ...
     <div class="container" style="width: 900px;, align-items: center;,
      ...
      <center>
        ...
        font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; ">Result Table</h1>
			</center>
 
      <a href="PCaddresult.php"  class="functionketCT">Add New Result</a>
      <table>
<thead>
    <th>ID</th>
    <th>Name</th>
...
<?php 
	...
	while($res = mysqli_fetch_array($result)) { 		
		...
		echo "<td><a class='updatetbtn' href='PCupdateresult.php?id=$res[id]'>Update</a>";  
		echo "<td><a class='deletebtn' href='delete-process3.php?id=$res[id]'>Delete</a>";        
	}
	?>
</tbody>
</table>
