...
{
alert(" Successfully Program Coordinator Details");
...
<body>
   ...
   <main>
     ...
     <section class="glassmiddle">
        ...
        font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; ">Create User</h1>
			</center>
			<form name='myform' action="PCuser.php" onsubmit="return validate()" method="post" enctype="multipart/form-data">
            <?php include('error.php'); ?>
                ...
                <input type="textfield" name="lname" required><br>
                <label>NIC:</label>
                <input type="textfield" name="nic" required><br>
                <label>Address:</label>   
                <input type="textfield" name="Address" required><br>
                <label>Mobile:</label>   
                <input type="textfield" name="Mobile" required><br>
                <label>Email:</label>   
				...
				<label>User Type:</label>
                    ...
                    <option value="P">Program Coordinator</option>
                    <option value="M">Markerting Staff</option>
