...
<head>
    ...
    <title>PC Update Payment page</title>
   ...
   <main>
     ...
     <section class="glassmiddle">
        ...
        font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; ">Update Student Result</h1>
			...
			<form name='myform' action="update-process5.php" onsubmit="return validate()" method="post" enctype="multipart/form-data">
            <?php include('error.php'); ?>
            <input type="hidden" name="id"  value=<?php echo $_GET['id'];?>><br>
                <label>Month id:</label>   
                <input type="textfield" name="Mid" required value="<?php echo $MID;?>"><br>
				<label>Amount:</label>   
                <input type="textfield" name="Amount" required value="<?php echo $Amount;?>"><br>
                
                
                
                <label>Last Date:</label>   
                <input type="Date" name="Pday" required value="<?php echo $Ldate;?>"><br>
                <label>Month:</label>   
                <select name="Month" class="Month" value="<?php echo $Month;?>" >
