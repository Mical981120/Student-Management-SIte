...
<head>
    ...
    <title>PC Add Result required page</title>
...
<body>
   ...
   <main>
     ...
     <section class="glassmiddle">
        ...
        font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; ">Add Student Result</h1>
			</center>
			<form name='myform' action="function.php" onsubmit="return validate()" method="post" enctype="multipart/form-data">
            <?php include('error.php'); ?>
                <label>User ID:</label>
                <input type="textfield" name="login" required><br>
				<label>User Name:</label>    
                <input type="textfield" name="Fname" required><br>
                <label>Student Index:</label>    
                <input type="textfield" name="Sindex" required><br>
                <label>Batch Number:</label>   
                <input type="textfield" name="Batch" required><br>
                <label>Course Index:</label>   
                <input type="textfield" name="Cindex" required><br>
                
                <label>Release Date:</label>   
                <input type="Date" name="Rday" required><br>
                ...
                <select name="Semester" class="Semester" >
                    ...
                    <label>Result:</label>   
                <input type="textfield" name="Result" required><br>
                <label>Grade:</label>   
                ...
                <input type="textfield" name="Feedback" required><br>

				<button type="submit" class="Addbtn" value="submit" name="addrt">Create</button>
