...
<head>
    ...
    <title>PC Add Assignment required page</title>
     ...
     <section class="glassmiddle">
        ...
        font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; ">Add Assingment</h1>
            ...
            <?php include('error.php'); ?>
                ...
                <input type="textfield" name="subid" required><br>
                <label>Batch Number:</label>   
                <input type="textfield" name="Batch" required><br>
                
                
                <label>Submission Date:</label>   
                <input type="Date" name="Sday" required><br>
                ...
                <select name="Semester" class="Semester" >
                    ...
                    <label>Add Assigment Breaf:</label>
                <input type="file"  name="myfile" required>
                <br>

				<button type="submit" class="Addbtn" value="submit" name="addss">Create</button>
