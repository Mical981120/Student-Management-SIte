...
<body>
   ...
   <main>
     ...
     <section class="glassmiddle">
        ...
        font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; ">Add Payment</h1>
			</center>
            ...
            <?php include('error.php'); ?>
                ...
                <input type="textfield" name="Mid" required><br>
				<label>Amount:</label>   
                <input type="textfield" name="Amount" required><br>
                
                
                
                <label>Last Date:</label>   
                <input type="Date" name="Pday" required><br>
                <label>Month:</label>   
				...
				<button type="submit" class="Addbtn" value="submit" name="addpt">Create</button>
