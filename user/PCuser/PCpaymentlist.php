...
$result = mysqli_query($mysqli, "SELECT * FROM pcpayment ORDER BY MID DESC");
...
<head>
    ...
    <title>PC Payement List page</title>
   ...
   <main style="display: flex;">
     ...
     <div class="container" style="width: 900px;, align-items: center;,
      ...
      <center>
        ...
        font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; ">Payment Table</h1>
			</center>
 
      <a href="PCaddpayment.php"  class="functionketCT">Add New Payment</a>
      <table>
<thead>
    <th>MID</th>
    <th>Amount</th>
...
<?php 
	...
	while($res = mysqli_fetch_array($result)) { 		
		echo "<tr>";
		echo "<td bgcolor=''>".$res['MID']."</td>";
		echo "<td>".$res['Amount']."</td>";
		echo "<td>".$res['Ldate']."</td>";
		echo "<td>".$res['Month']."</td>";	
		
		echo "<td><a class='updatetbtn' href='PCupdatepayment.php?id=$res[id]'>Update</a>";  
		echo "<td><a class='deletebtn' href='delete-process4.php?id=$res[id]'>Delete</a>";        
	}
	?>
</tbody>
</table>
