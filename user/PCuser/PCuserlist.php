...
$result = mysqli_query($mysqli, "SELECT * FROM users ORDER BY login DESC");
   ...
   <main style="display: flex;">
     ...
     <div class="container" style="width: 700px;, align-items: center;,
      ...
      <center>
        ...
        font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; ">User Table</h1>
			</center>
 
      <a href="PCuser.php"  class="functionketCT">Add New User</a>
      <table>
<thead>
...
<?php 
	...
	while($res = mysqli_fetch_array($result)) { 		
        ...
        echo "<td>".$res['NIC']."</td>";
		echo "<td><a class='updatetbtn' href='PCupdateuserd.php?id=$res[id]'>Update</a>";  
		echo "<td><a class='deletebtn' href='delete-process.php?id=$res[id]'>Delete</a>";        
	}
	?>
</tbody>
</table>
